...
<?php endif;?>
  ...
  <h5 class="newsletter--ribbon"><?php print t('EiE News'); ?></h5>

<div class="newsletter--embed">

  <form action="https://madmimi.com/signups/subscribe/46876"; method="post" id="mad_mimi_signup_form" target="_blank">
    ...
    <div class="row">
      <div class="small-12 columns">
        <input id="webform_submit_button" name="commit" value="Sign Up" type="submit" class="submit btn" data-default-text="Sign Up" data-submitting-text="Sending..." data-invalid-text="required">
      </div>
    </div>
  </form>
